...
NEWS_DAILY_BRIEF_TEXT = {
    ...
    "中文": {
        ...
        "why_important": "为什么重要",
        "view_citations": "展开查看引用新闻",
        "citation_news": "引用新闻",
        "open_article": "打开文章",
        "fallback_data": "备用数据",
        "published_unknown": "发布时间未知",
        "source_unknown": "来源未知",
        "no_verified_citations": "暂无可验证引用",
        "citation_incomplete": "引用数据不完整",
    ...
    "Español": {
        ...
        "why_important": "Por qué importa",
        "view_citations": "Ver noticias citadas",
        "citation_news": "Noticias citadas",
        "open_article": "Abrir artículo",
        "fallback_data": "Datos alternativos",
        "published_unknown": "Hora de publicación desconocida",
        "source_unknown": "Fuente desconocida",
        "no_verified_citations": "No hay citas verificables",
        "citation_incomplete": "Los datos de la cita están incompletos",
